...
const AnalysisTabs = ({ analyses }: { analyses: Analysis[] }) => {
            ...
            <>
              ...
              <div className="bg-white xl:min-w-96 border border-gray-100 shadow-sm rounded-md p-4 flex flex-col gap-4">
                <div className="flex flex-col">
                  ...
                  <p>
                    {" "}
                    Visual explanation of the DICOM file uploaded. The image
                    below is the summed image from the entire DICOM sequence. A
                    heatmap overlay represents the area of interest chosen by
                    the AI
                  </p>
                </div>
