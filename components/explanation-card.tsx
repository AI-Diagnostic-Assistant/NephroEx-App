                ...
                {explanation.shapValuesRenogram && (
                    <div className="flex flex-wrap gap-4 w-full">
                        <div className="bg-primary-foreground px-3 py-10 rounded-lg w-full">
                            <BarChartShap shapValues={explanation.shapValuesRenogram[0]} featureValues={explanation.shapValuesRenogram[1]}/>
                        </div>
                        <div className="bg-primary-foreground px-3 py-10 rounded-lg w-full">
                            <WaterfallChartShap shapValues={explanation.shapValuesRenogram[0]} featureValues={explanation.shapValuesRenogram[1]} baseValue={explanation.shapValuesRenogram[2][0]} confidence={confidence}/>
                        </div>
                    </div>
                )}
            </div>
